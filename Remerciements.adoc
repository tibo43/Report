...
L'accueil, le soutient et les connaissances du pôle _Expertise_ d'ISC France m'ont donné l'opportunité de me familiariser avec la culture _DevOps_ et le _continuous delivery_.

La gentillesse et la disponibilité de tous les collaborateurs d'ISC France m'ont permis de me sentir intégrer à l'entreprise.
